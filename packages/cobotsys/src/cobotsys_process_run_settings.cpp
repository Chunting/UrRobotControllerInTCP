...
std::ostream& operator<<(std::ostream& oss, TaskProcessType t) {
    switch (t) {
    case TaskProcessType::Program:oss << std::setw(12) << "Program";
        break;
    case TaskProcessType::BashScript:oss << std::setw(12) << "BashScript";
        break;
    case TaskProcessType::RosProgram:oss << std::setw(12) << "RosProgram";
        break;
    }
    return oss;
}
